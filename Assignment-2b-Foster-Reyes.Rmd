...
Anger Expression Mean (M, or $\bar{x}$): `r round(ae.mean, 3)`

Anger Expression Standard Deviation (s): `r round(ae.sd, 3)`
...
Number of men sampled: `r male.sample.size`

### b.

Number of women sampled: `r female.sample.size`
...
$\sigma_{M_{AOm} - M_{AOf}} = \sqrt{\frac{\sigma_{AOm}^2}{n_{AOm}} + \frac{\sigma_{AOf}^2}{n_{AOf}}}$

$\sigma_{M_{AOm}}^2 = \frac{\sigma_{AOm}^2}{n_{AOm}}$ = `r male.sampling.variance`

$\sigma_{M_{AOf}}^2 = \frac{\sigma_{AOf}^2}{n_{AOf}}$ = `r female.sampling.variance`

$\sigma_{M_{AOm} - M_{AOf}}^2 = \sigma_{M_{AOm}}^2 + \sigma_{M_{AOf}}^2$

$\sigma_{M_{AOm} - M_{AOf}} = \sqrt{`r male.sampling.variance` + `r female.sampling.variance`}$

$\sigma_{M_{AOm} - M_{AOf}} =$ `r mf.sampling.diff.se`
