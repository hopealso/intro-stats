...
Percentile  | b. Normal Distribution  | Actual (Type 6)  | Actual (Type 7)  |
------------|-------------------------|------------------|------------------| 
25          | `r normal.out(0.25)` | `r actual.out(0.25, 6)` | `r actual.out(0.25, 6)` |
50          | `r normal.out(0.50)` | `r actual.out(0.50, 6)` | `r actual.out(0.50, 6)` |
75          | `r normal.out(0.75)` | `r actual.out(0.75, 6)` | `r actual.out(0.75, 6)` |
